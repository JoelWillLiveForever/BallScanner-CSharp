...
namespace Joel.Controls
{
    public partial class CustomWindow
    {
        ...
        private Visibility reverseMaximizeButtonVisiility;
        ...
        public CustomWindow()
        {
            ...
            // WorkingArea + MaxHeight
            Rectangle workingArea = screen.WorkingArea;
            base.MaxHeight = (double)(workingArea.Height + 16.0d) / currentDPIScaleFactor;

            // Display settings changed event handler
        ...
        private void OnStateChanged(object sender, EventArgs e)
        {
            ...
            if (this.WindowState != WindowState.Maximized)
            {
                ...
                Rectangle workingArea = screen.WorkingArea;
                this.MaxHeight = (double)(workingArea.Height + 16.0d) / currentDPIScaleFactor;
            ...
            } else
            {
                ...
                if (this.PreviousState == WindowState.Minimized || this.Left == this.positionBeforeDrag.X && this.Top == positionBeforeDrag.Y)
                {
        ...
        private void SetMaximizeButtonsVisibility(Visibility visible, Visibility collapsed)
        {
